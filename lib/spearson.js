(function (exports) {
    ...
    var round, min, max, range, sum, mean, deviation, variance, standardDeviation, standardize,
        rank, correlation, distance, pairwiseDistance, linkage, hierarchicalClustering;
